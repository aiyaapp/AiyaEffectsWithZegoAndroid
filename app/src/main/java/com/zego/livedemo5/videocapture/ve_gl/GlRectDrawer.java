...
public class GlRectDrawer {
    ...
    public static final String RGB_FRAGMENT_SHADER_STRING =
            "precision mediump float;\n"
                    + "varying vec2 interp_tc;\n"
                    + "\n"
    ...
    public static final String OES_FRAGMENT_SHADER_STRING =
    ...
    public void prepareShader(String fragmentShader, float[] texMatrix) {
        if (!shaders.containsKey(fragmentShader)) {
            shaders.put(fragmentShader, new Shader(fragmentShader));
        }
    }

    public void userProgram(String fragmentShader, float[] texMatrix) {
        final Shader shader;
        if (shaders.containsKey(fragmentShader)) {
