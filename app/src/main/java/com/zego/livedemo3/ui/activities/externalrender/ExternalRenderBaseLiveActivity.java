 ...
 * des: 主页面
 */
public abstract class ExternalRenderBaseLiveActivity extends AbsShowActivity {
...
//        setRotateFromInterfaceOrientation(mCurrentOrientation);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        vlBigView.setViewLiveCallback(new ViewLive.ViewLiveCallback() {
            ...
            public void shareToQQ(List<String> listShareUrls) {
                ShareUtils.getInstance().shareToQQ(ExternalRenderBaseLiveActivity.this, vlBigView.getListShareUrls(), mRoomKey, mServerKey, mPublishStreamID);
            }
        });
    ...
    protected void startPlay(String streamID, ZegoAVKitCommon.ZegoRemoteViewIndex remoteViewIndex) {
        ...
        mZegoAVKit.setZegoExternalRenderCallback(videoRenderer);
