 ...
 * des: 主页面
 */
public abstract class MorAnchorsBaseLiveActivity extends AbsShowActivity {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        vlBigView.setViewLiveCallback(new ViewLive.ViewLiveCallback() {
            ...
            public void shareToQQ(List<String> listShareUrls) {
                ShareUtils.getInstance().shareToQQ(MorAnchorsBaseLiveActivity.this, vlBigView.getListShareUrls(), mRoomKey, mServerKey, mPublishStreamID);
            }
        });
