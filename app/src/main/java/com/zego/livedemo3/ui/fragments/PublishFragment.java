...
import com.zego.livedemo3.aiya.AiyaMenu;
...
public class PublishFragment extends AbsBaseFragment {
    ...
    protected void initViews() {
        ...
        ArrayAdapter<String> filterAdapter = new ArrayAdapter<>(mParentActivity,
...
//                }
                Log.e("seteff","setEffect-"+mAiyaMenu.getMenuList().get(mSelectedFilter).path);
